module github.com/wjlin0/deadpool
...
require (
	...
	github.com/peakedshout/go-CFC v1.3.4 // indirect
	github.com/peakedshout/go-socks v1.0.1-0.20250214070816-ed825f00dc98 // indirect
